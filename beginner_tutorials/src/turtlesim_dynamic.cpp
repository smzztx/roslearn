...
#include <beginner_tutorials/dynamicConfig.h>
...
void dynamic_callback(beginner_tutorials::dynamicConfig &config)
...

{
    ...
    ros::init(argc, argv, "turtlesim_dynamic_node_a");

    ros::NodeHandle handle;

 

    dynamic_reconfigure::Server<beginner_tutorials::dynamicConfig> server;

    dynamic_reconfigure::Server<beginner_tutorials::dynamicConfig>::CallbackType callback;
